...
function alwaysHungry(arr) {
    ...
    if (newArr.includes("yummy")){
        console.log(newArr)
    }
    
    // string.includes() method returns true if a string contains a specified string
    // The includes() method is case sensitive can do toLowerCase().includes() to get around this
    // syntax is string.includes(searchString, position) position is certain index in the string (optional)
